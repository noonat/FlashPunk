package Control
{
	...
	public class Menu extends World
	{
		...
		public var sprNewGameHover:Image = new Image(Assets.MENU, new Rectangle(0, 64, 640, 64));
		public var sprLoadGame:Image = new Image(Assets.MENU, new Rectangle(0, 128, 640, 64));
